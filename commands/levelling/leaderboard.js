...
module.exports = class Command extends Commando.Command {
	...
	async run(message) {
		...
		const embed = new MessageEmbed().setTitle('Ranking Leaderboard').setAuthor(message.guild.name, message.guild.iconURL()).setColor(message.client.config.discord.accentColor);
