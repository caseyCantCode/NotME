...
module.exports = class Command extends Commando.Command {
	...
	async run(message) {
		...
		const embed = new MessageEmbed().setTitle('Leaderboard').setAuthor(message.guild.name, message.guild.iconURL()).setDescription('Our top 10 XP leaders!').setColor(message.client.config.discord.accentColor);
