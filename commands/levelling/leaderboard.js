...
module.exports = class Command extends Commando.Command {
	...
	async run(message) {
		...
		const embed = new MessageEmbed().setTitle('Ranking Leaderboard').setAuthor(`${message.guild.name}'s`, message.guild.iconURL()).setColor(this.client.config.discord.accentColor);
